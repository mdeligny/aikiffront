angular
  ...
  .controller('newMerchantItemCtrl', function ($stateParams, $q, $rootScope, $http, $scope, errorsService) {
    ...
    $http.get('https://aikiff.herokuapp.com/categories').then(function (response) {
    ...
    vm.addNewMerchant = function () {
      ...
      if (newImages.length > 0) {
        ...
        uploadPromise = $http.post('https://aikiff.herokuapp.com/upload', formData, {
        ...
        .then(function (imageLink) {
          localizeUser()
            .then(function (coordonnes) {
              ...
              $http.post('https://aikiff.herokuapp.com/merchants', merchant)
                .then(function () {
